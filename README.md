...
- `index.html` — landing page structure, including a portfolio slideshow section
- `styles.css` — responsive styling

## How to use

Open `index.html` in a browser or use a local static server to preview the site.
